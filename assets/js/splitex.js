...
$(function () {
  ...
  $('#home-bg-left').vegas({
    ...
    slides: [
      {
        src:'assets/img/background/home-bg-left.jpg',
      },
    ],
  });
  ...
  $('#about-bg-left').vegas({
    ...
    slides: [
      {
        src:'assets/img/background/about-bg-left.jpg',
      },
    ],
  });
  // works IMG left
  $('#works-bg-left').vegas({
    ...
    slides: [
      {
        src:'assets/img/background/works-bg-left.jpg',
      },
    ],
  });
  // contact IMG left
  $('#contact-bg-left').vegas({
    ...
    slides: [
      {
        src: 'assets/img/background/contact-bg-left.jpg',
      },
    ],
  });
  // home IMG right
  $('#home-bg-right').vegas({
    ...
    slides: [
      {
        src: 'assets/img/background/home-bg-right.jpg',
      },
    ],
  });
  // about IMG right
  $('#about-bg-right').vegas({
    ...
    slides: [
      {
        src: 'assets/img/background/about-bg-right.jpg',
      },
    ],
  });
  // works IMG right
  $('#works-bg-right').vegas({
    ...
    slides: [
      {
        src: 'assets/img/background/works-bg-right.jpg',
      },
    ],
  });
  // contact IMG right
  $('#contact-bg-right').vegas({
    ...
    slides: [
      {
        src: 'assets/img/background/contact-bg-right.jpg',
      },
    ],
  });
  // slider IMG left
  $('#left-bg-1').vegas({
    ...
    slides: [
      {
        src: 'assets/img/background/slide-left-1.jpg',
      },
      {
        src: 'assets/img/background/slide-left-2.jpg',
      },
      {
        src: 'assets/img/background/slide-left-3.jpg',
      },
      {
        src: 'assets/img/background/slide-left-4.jpg',
      },
    ],
  });
  // slider IMG right
  $('#right-bg-1').vegas({
    ...
    slides: [
      {
        src: 'assets/img/background/slide-right-1.jpg',
      },
      {
        src: 'assets/img/background/slide-right-2.jpg',
      },
      {
        src: 'assets/img/background/slide-right-3.jpg',
      },
      {
        src: 'assets/img/background/slide-right-4.jpg',
      },
    ],
  });
